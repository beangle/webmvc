...
val beangle_template_api = "org.beangle.template" %% "beangle-template-api" % "0.0.35"
val beangle_template_freemarker = "org.beangle.template" %% "beangle-template-freemarker" % "0.0.35"

val beangle_web_action = "org.beangle.web" %% "beangle-web-action" % "0.0.3"
val beangle_web_servlet = "org.beangle.web" %% "beangle-web-servlet" % "0.0.3"
