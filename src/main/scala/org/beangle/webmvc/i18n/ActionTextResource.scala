...
class ActionTextResource(context: ActionContext, action: ActionMapping, locale: ju.Locale, registry: TextBundleRegistry,
                         formatter: TextFormatter, cache: ActionTextCache)
